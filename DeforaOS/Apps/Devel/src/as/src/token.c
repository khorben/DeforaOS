...
TokenCode TS_INSTRUCTION_LIST[] = { TC_NEWLINE, TC_SPACE, TC_NULL };
TokenCode TS_NEWLINE[] = { TC_SPACE, TC_TAB, TC_NEWLINE, TC_NULL };
TokenCode TS_NEWLINE_LIST[] = { TC_SPACE, TC_TAB, TC_NEWLINE, TC_NULL };
TokenCode TS_OPERAND[] = { TC_WORD, TC_NUMBER, TC_NULL };
TokenCode TS_OPERAND_LIST[] = { TC_WORD, TC_NUMBER, TC_NULL };
