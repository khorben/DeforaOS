...
<? if(isset($entry['module']) && isset($entry['id'])) { ?>
			<input type="hidden" name="entry_<? echo $explorer_id.'_'.$i; ?>_module" value="<? echo _html_safe($entry['module']); ?>"/>
			<input type="hidden" name="entry_<? echo $explorer_id.'_'.$i; ?>_id" value="<? echo _html_safe($entry['id']); ?>"/>
<? } ?>
