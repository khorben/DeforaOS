...
<?php } ?>
		...
		<td></td><td><button type="reset" class="icon reset"><?php echo _html_safe(RESET); ?></button> <button type="submit" class="icon search"><?php echo _html_safe(FILTER); ?></button></td></tr>
	</table>
</form>
