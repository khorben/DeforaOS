...
<table>
	<tr><td class="field"><? echo _html_safe(PROJECT); ?>:</td><td><a href="index.php?module=project&amp;action=bug_list&amp;project_id=<? echo _html_safe($bug['project_id']); ?>"><? echo _html_safe($bug['project']); ?></a></td><td class="field"><? echo _html_safe(SUBMITTER); ?>:</td><td><a href="index.php?module=user&amp;id=<? echo _html_safe($bug['user_id']); ?>"><? echo _html_safe($bug['username']); ?></a></td></tr>
