<form action="<?php echo _html_link(); ?>" method="post" enctype="multipart/form-data">
	...
	<table>
		...
		<tr><td></td><td><a href="<?php echo _html_link('project', 'download', $project['id']); ?>"><button type="button" class="icon cancel"><?php echo _html_safe(CANCEL); ?></button></a> <input type="submit" value="<?php echo _html_safe(UPLOAD); ?>" class="icon submit"/></td></tr>
	</table>
</form>
