...
<? } else { ?>
		<a href="index.php?module=news&amp;id=<? echo _html_safe_link($news['id']); ?>"><img src="icons/16x16/read.png" alt=""/> <? echo _html_safe(READ); ?></a>
<? if(_module_id('comment')) { ?>
		(<? echo _html_safe(_module('comment', 'count', array('id' => $news['id'])).' '.COMMENT_S); ?>)
		· <a href="index.php?module=comment&amp;action=new&amp;parent=<? echo _html_safe($news['id']); ?>#edit"><img src="icons/16x16/reply.png" alt=""/> <? echo _html_safe(REPLY); ?></a>
<? } } ?>
