	<div class="entry">
		<div class="title"><span><span><span><? echo $i; ?>. <a href="index.php?module=<? echo _html_safe_link($q['module']); ?>&id=<? echo _html_safe_link($q['id']); ?>"><? echo _html_safe($q['title']); ?></a></span></span></span></div>
