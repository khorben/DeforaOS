	<div class="entry">
		...
		<div class="author"><?php echo _html_safe(SEARCH_BY); ?> <a href="<?php echo _html_link('user', FALSE, $q['user_id'], $q['username']); ?>"><?php echo _html_safe($q['username']); ?></a></div>
		<div class="date"><?php echo _html_safe(SEARCH_ON); ?> <?php echo _html_safe($q['date']); ?></div>
