...
<form action="index.php" method="post">
	...
	<input type="hidden" name="action" value="<? echo isset($bookmark['id']) ? 'update' : 'insert'; ?>"/>
...
<? } ?>
	<table>
		...
		<tr><td class="field">Description:</td><td><textarea name="content" cols="50" rows="3"><? echo _html_safe($bookmark['content']); ?></textarea></td></tr>
		...
		<tr><td></td><td><input type="submit" value="<? echo isset($bookmark['id']) ? _html_safe(UPDATE) : _html_safe(SEND); ?>"/></td></tr>
	</table>
</form>
