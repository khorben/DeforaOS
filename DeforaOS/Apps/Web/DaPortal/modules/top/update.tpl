...
<?php } ?>
	<table>
		<tr><td class="field">Name:</td><td><input type="text" name="name" value="<?php if(isset($top['name'])) echo _html_safe($top['name']); ?>" size="40"/></td></tr>
		<tr><td class="field">Address:</td><td><input type="text" name="link" value="<?php if(isset($top['link'])) echo _html_safe($top['link']); ?>" size="40"/></td></tr>
