...
<?php } ?>
	<table>
		<tr><td class="field"><?php echo _html_safe(NAME); ?>:</td><td><input type="text" name="title" value="<?php echo _html_safe($category['name']); ?>" size="50"/></td></tr>
		<tr><td class="field">Description:</td><td><input type="text" name="content" value="<?php echo _html_safe($category['content']); ?>" size="50"/></td></tr>
