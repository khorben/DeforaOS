...
if($article['id'] && _user_admin($user_id)) { ?>
		&middot; <a href="index.php?module=article&amp;action=modify&amp;id=<?php echo _html_safe($article['id']); ?>"><img src="icons/16x16/edit.png" alt=""/> <?php echo _html_safe(EDIT); ?></a>
<?php if($article['enabled'] == SQL_TRUE) { ?>
		&middot; <a href="index.php?module=content&amp;action=disable&amp;id=<?php echo _html_safe($article['id']); ?>&amp;show"><img src="icons/16x16/disabled.png" alt=""/> <?php echo _html_safe(DISABLE); ?></a>
<?php } else { ?>
		&middot; <a href="index.php?module=content&amp;action=enable&amp;id=<?php echo _html_safe($article['id']); ?>&amp;show"><img src="icons/16x16/enabled.png" alt=""/> <?php echo _html_safe(ENABLE); ?></a>
<?php } } } ?>
	</div>
</div>
